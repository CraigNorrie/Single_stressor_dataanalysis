...
```{r, echo=FALSE}
#There seem to be 70 moralities missing from the events. Where are they?
...
I am going to add a random effect of tank here to assess inter tank variation. I am using the frailtyEM package (Balan and Putter 2019) as in McElhany. I am going to include treatment and ploidy as fixed effects tank as a random effect. 
