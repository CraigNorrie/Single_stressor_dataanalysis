...
```{r}
temprates_summary <- temp_resprates %>% group_by(Treatment, Ploidy) %>% 
  summarise(temp_mean_resprate= mean(mass_corected_rate, na.rm = TRUE), sem_temp_resprate = sd(mass_corected_rate, na.rm = TRUE)/n())
```
